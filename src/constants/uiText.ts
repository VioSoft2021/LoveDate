...
export const UI_TEXT = {
  en: {
    ...
    auth: {
      ...
      forgotPasswordSent: 'If that email exists, a recovery link is on its way. Check your inbox.',
      forgotPasswordFailed: 'Couldn\'t send the recovery email. Try again in a moment.',
  ...
  ro: {
    ...
    auth: {
      ...
      forgotPasswordSent: 'Dacă acest email există, un link de recuperare este pe drum. Verifică inbox-ul.',
      forgotPasswordFailed: 'Nu am putut trimite email-ul. Încearcă din nou peste un moment.',
