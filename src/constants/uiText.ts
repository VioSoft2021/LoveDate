...
export const UI_TEXT = {
  en: {
    ...
    profile: {
      ...
      cognitiveOverlap: 'Cognitive overlap',
      // Personality guide screen
      personalityGuide: 'Personality Guide',
      personalityGuideSubtitle: 'Understanding Privé Personality Codes',
      personalityCodeExample:
        "Example: DMFR means Decisive, Mindful, Feeling, Reserved. Each letter describes how you naturally approach connection.",
  ...
  ro: {
    ...
    profile: {
      ...
      cognitiveOverlap: 'Suprapunere cognitivă',
      // Ghid personalitate
      personalityGuide: 'Ghid de personalitate',
      personalityGuideSubtitle: 'Înțelege codurile de personalitate Privé',
      personalityCodeExample:
        'Exemplu: DMFR înseamnă Decisiv, Mindful, Feeling, Rezervat. Fiecare literă descrie felul în care abordezi conexiunea.',
