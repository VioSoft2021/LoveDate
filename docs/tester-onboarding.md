...
2. Chats screen: send at least 1 text and 1 media item.
3. Profile screen: edit bio and save changes.
4. Settings screen: toggle one setting and verify it persists.

## How To Report Bugs
When reporting an issue, include:
- Device and browser (example: iPhone 14, Safari)
- Exact steps taken
